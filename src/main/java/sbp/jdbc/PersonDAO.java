...
public class PersonDAO {
    ...
    public PersonDAO() {
        ...
        if (this.osName.contains("Mac OS")) {
            this.jdbcUrl = "jdbc:sqlite:/Users/sproshchaev/Documents/Java/GIT/lecture4/db/lecture4.db";
        } else {
            this.jdbcUrl = "jdbc:sqlite:/Users/Сергей/Documents/Java/GIT/lecture4/db/lecture4.db";
        }
