...
class PersonTests {
    ...
    @Test
    void test_false_Equals() throws PersonExceptions {
        Person person = new Person("E", "City1", 11);
        PersonTest.MyNestedClass myNestedClass = new  PersonTest.MyNestedClass();
        Assert.assertFalse(person.equals(myNestedClass));
    }
    ...
    void test_nameNull_Person()  {
         ...
         *  @throws PersonExceptions if name == null
         */
    ...
    void test_cityNull_Person()  {
        ...
        /**
         *  Объявление экземпляров класса Person, вызывающих исключение
         *  @throws PersonExceptions if city == null
         */
    ...
    void test_ageZero_Person()  {
        ...
        /**
         *  Объявление экземпляров класса Person, вызывающих исключение
         *  @throws PersonExceptions if age == 0
         */
        String cityNotNull = "City";
        String nameNotNull = "Name";
        int ageNotZero = 20;
